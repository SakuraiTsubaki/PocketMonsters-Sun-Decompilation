...
- [ ] Inventory the first verified Sun target
...
Run `tools/inventory_target.py` on the first local Sun target or extracted tree, register exact identity, then begin NCCH/ExeFS/RomFS structural mapping. Retail bytes and keys remain local.
