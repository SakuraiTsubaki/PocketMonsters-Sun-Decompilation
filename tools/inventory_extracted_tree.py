...
def main() -> int:
    ...
    parser.add_argument("root", type=Path, help="Locally extracted game directory")
    parser.add_argument("-o", "--output", type=Path, default=Path("inventory.json"))
    parser.add_argument("--project", default=None, help="Optional project/game label")
    parser.add_argument("--platform", default=None, help="Optional platform label")
    ...
    payload = {
        "schema": "sakurai.decompilation.inventory.v1",
